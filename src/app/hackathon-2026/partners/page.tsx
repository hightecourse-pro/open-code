...
const VALUE_PATH = [
  ...
  },
  {
    ...
    body: "אתם מביאים אתגר אמיתי מהשטח שלכם — מסמכים, דאטה, תהליך שמבקש אוטומציה. אנחנו עוזרות למסגר אותו כאתגר האקתון.",
    side: "self-start",
    tilt: "rotate-1",
  },
  {
    emoji: "🏆",
    title: "ופוגשים יכולות מוכחות",
    body: "עשרות מפתחות בונות פתרון לאתגר שלכם, ובערב הגמר אתם רואים פתרונות עובדים — ואת המפתחות שבנו אותם 💜",
    side: "self-end",
    tilt: "-rotate-1",
  },
];
...
const VALUE_CARDS = [
  { emoji: "🔍", title: "גישה מוקדמת לטאלנט", body: "אתם פוגשים את המפתחות החזקות לפני כולם — לא דרך קורות חיים, דרך פתרון עובד לבעיה שלכם.", tilt: "-rotate-2" },
      ...
      <section className="px-6 pt-6 pb-16 bg-[#FDF3F9] relative">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="font-display font-black text-[22px] mt-1">רוצים אתגר משלכם על הבמה? ✨</div>
            <div className="font-display font-bold text-[16.5px] mt-1 opacity-95">
              מקומות השותפות לאירוע מוגבלים — נשמח לתפור יחד את האתגר שלכם 🏆
            </div>
          </div>
