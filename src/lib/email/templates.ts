...
export function questionnaireReminderEmail(name: string | undefined, track: "mentor" | "junior"): BuiltEmail {
  ...
  if (track === "mentor") {
    return {
      ...
      html: renderEmail({
        heading: `${hello}רגע קטן לפני שממשיכות 👑`,
        lines: [
          "ראינו שנרשמת אלינו כמנטורית - תודה, זה משמח אותנו מאוד. השאלון שלך נשאר באמצע, ורצינו רק להזכיר בעדינות.",
  ...
  return {
    ...
    html: renderEmail({
      heading: `${hello}רגע קטן לפני שממשיכות 💜`,
      lines: [
        "ראינו שהתחלת למלא את השאלון ועצרת באמצע. אנחנו לגמרי מבינות - הוא ארוך, ואחרי יום שלם זה לא בדיוק מה שמתחשק.",
