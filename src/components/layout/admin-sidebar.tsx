...
const ITEMS: AdminNavItem[] = [
  ...
  { href: "/admin/payments", label: "תשלומים חיצוניים", icon: CreditCard },
  { href: "/admin/crm", label: "CRM לקוחות", icon: ContactRound },
  { href: "/admin/clients", label: "לקוחות פורטל", icon: Building2 },
