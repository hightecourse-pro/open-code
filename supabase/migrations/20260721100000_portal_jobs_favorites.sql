-- ============================================================================
-- Promoted to a migration on 2026-08-17. This ran by hand in the SQL Editor as
-- supabase/_portal_jobs_favorites.sql, so it existed in the live database but in no migration —
-- meaning a database built from migrations/ alone was missing it. Every
-- statement is safe to re-run, so applying this to the existing project is a
-- no-op and applying it to a fresh project creates the objects.
-- Must run BEFORE the jobs CRM migration, which adds columns to job_candidates.
-- ============================================================================
-- ============================================================================
